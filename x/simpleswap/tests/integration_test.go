...
import (
	...
	_ "github.com/cosmos/simpleswap/module"
	...
	simpleswapmodulev1 "github.com/cosmos/simpleswap/api/module/v1"
	"github.com/cosmos/simpleswap/keeper"
)

// ExampleModule is a configurator.ModuleOption that add the simpleswap module to the app config.
var ExampleModule = func() configurator.ModuleOption {
	return func(config *configurator.Config) {
		config.ModuleConfigs[simpleswap.ModuleName] = &appv1alpha1.ModuleConfig{
			Name:   simpleswap.ModuleName,
			Config: appconfig.WrapAny(&simpleswapmodulev1.Module{}),
		}
	}
}
